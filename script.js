...
function createSingleIndex(Contact) {
    ...
    /* 1.create a DOM node to represent single index card for index page
    2. Paramater is a single object that represents a contact
    3. Output of this function is a DOM node */
   }
...
function renderIndex(contactList) {
    ...
    /* 1. creates all DOM nodes unique to the index page
    2. Parameter is an array that can take in contacts 
*/
